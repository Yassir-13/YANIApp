...
%  Rapport de projet de fin d'année — Yani Concept by Fati
% ═══════════════════════════════════════════════════════════════════
...
\usepackage{float}
\usepackage{tikz}
% `calc` fournit la syntaxe ($(a)+(x,y)$), qui permet de positionner les
% éléments de la page de garde par rapport aux coins de la page.
\usetikzlibrary{calc}
...
% Les adresses de la webographie sont longues et ne contiennent aucun point de
% coupure naturel : sans xurl, elles débordent dans la marge. Il autorise la
% coupure à n'importe quel caractère de l'URL.
\usepackage{xurl}
...
% ═══════════════════════════════════════════════════════════════════
%  Couleurs institutionnelles EMSI — page de garde uniquement
% ═══════════════════════════════════════════════════════════════════
%  La couverture suit la charte de l'école ; le corps du rapport garde la
%  palette du projet définie au-dessus. C'est l'usage : l'établissement
%  s'affiche sur la couverture, le projet à l'intérieur.
%
%  Pour une couverture aux couleurs du projet plutôt qu'à celles de l'école,
%  il suffit de faire pointer ces deux noms ailleurs :
%      \colorlet{jauneEMSI}{yaniOr}
%      \colorlet{vertEMSI}{yaniOrProfond}
\definecolor{jauneEMSI}{RGB}{234, 224, 15}
\definecolor{vertEMSI}{RGB}{0, 120, 70}
\definecolor{ombre}{RGB}{225, 225, 225}

% ═══════════════════════════════════════════════════════════════════
%  Logo de la page de garde, avec repli si le fichier manque
% ═══════════════════════════════════════════════════════════════════
%  Même principe que \figProjet : le document compile avant que les logos
%  n'aient été déposés dans figures/, et un cadre nomme le fichier attendu.
%  Usage : \logoCouverture{EMSI.png}{2.1cm}
