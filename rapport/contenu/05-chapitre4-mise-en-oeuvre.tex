...
autant que le script lui-même :

\begin{itemize}[leftmargin=1.2cm]
  \item \textbf{le cliché doit être recopié hors de la machine} --- une
  sauvegarde qui vit sur le serveur qu'elle sauvegarde ne protège de rien ;
  \item \textbf{les images du catalogue vivent hors de la base} et ne sont pas
  couvertes par ce script : leur dossier doit être copié séparément.
\end{itemize}
