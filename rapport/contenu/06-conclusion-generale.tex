...
\begin{itemize}[leftmargin=1.2cm]
  ...
  \item \textbf{la sécurité} --- hachage Argon2, jetons courts, rotation avec
  détection de réutilisation, autorisation vérifiée par le serveur sur chaque
  route, validation stricte des entrées, contrôle des fichiers téléversés par
  leur signature binaire.
\end{itemize}
