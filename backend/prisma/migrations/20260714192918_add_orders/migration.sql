/*
  ...
  - A unique constraint covering the columns `[order_id]` on the table `loyalty_transactions` will be added. If there are existing duplicate values, this will fail.
...
-- AlterTable
ALTER TABLE "loyalty_transactions" ADD COLUMN     "order_id" TEXT;
